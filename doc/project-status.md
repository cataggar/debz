...
Fresh roots use a v3 helper bootstrap only when the exact authenticated owner
...
evidence, unknown probe outcomes block, and terminal cleanup removes the
private source without ever publishing a placeholder or invoking dpkg tools.
