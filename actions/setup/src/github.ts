...
export const RELEASE_REPOSITORY = 'debz';
export const RELEASE_REPOSITORY_ID = 1_333_810_920;
export const RELEASE_OWNER_ID = '87583576';
export const RELEASE_REPOSITORY_URL = 'https://github.com/cataggar/debz';
...
export function selectReleaseAsset(
  ...
  const expectedName = `debz-${version}-${target}.tar.gz`;
