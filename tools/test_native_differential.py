...
class NativeDifferentialTests(unittest.TestCase):
    ...
    def test_scenario_inventory_names_required_v1_cases(self) -> None:
        ...
        inventory = {
            ...
            "archive-revalidation-mismatch",
            "healthy-root-import",
            "mutation-journal-recovery",
            "mutation-external-modification",
            "mutation-backup-restore",
            "mutation-cross-device-refused",
            "corrupt-root-rejected",
            "filesystem-interruption",
            "database-interruption",
            "script-outcome-unknown",
            "native-recovery-prepared",
            "native-recovery-filesystem",
            "native-recovery-database",
            "native-recovery-script-prepared",
            "native-recovery-script-recorded",
            "native-recovery-script-unknown",
            "native-recovery-unpack-script-unknown",
            "native-recovery-failure-compensation",
            "native-recovery-trigger-recorded",
            "native-recovery-provenance-completion",
            "native-recovery-changed-evidence",
            "unpack-data-only",
